      ...
      <div>
        <section className="py-20 bg-indigo-100">
          <div className="container max-w-6xl mx-auto">
            {courses ? (
              <>
                <h2 className="text-4xl font-bold tracking-tight text-center">Courses related to "{searchKeyword}"</h2>
              </>
            ) : (
              ""
            )}
            <div className="p-4 grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
              {courses ? (
                ...
                <div className="col-span-12 text-center py-5 mx-auto text-2xl">
                  <img src="../../no-courses.svg" className="w-96 mx-auto mb-2" />
                  <p className="my-10 font-bold text-indigo-400">Sorry! No records available for "{searchKeyword}".</p>
                </div>
              )}
            </div>
          </div>

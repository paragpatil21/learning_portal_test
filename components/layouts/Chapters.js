    ...
    <>
      {courses ? (
        courses.map((course, index) => {
          return (
            <div className="relative border border-blue-400 flex justify-start items-center col-span-4 px-5 overflow-hidden bg-white rounded-xl text-gray-700">
              <div className="w-24 h-24 my-4">
                <div className="border relative inline-flex items-center justify-center rounded-full overflow-hidden">
                  <svg className="w-24 h-24 transform -rotate-90">
                    <circle className="text-gray-200" stroke-width="4" stroke="currentColor" fill="transparent" r="46" cx="48" cy="48" />
                    <circle
              ...
              <div className="pl-5 my-4">
                <span className="text-xs">Chapter {index + 1}:</span>
                <h4 className="text-md font-medium">{course.Title}</h4>
                <Link href={isStudentLoggedIn() === true ? "/courses/" + course.Slug : "/login?refer=/courses/" + course.Slug}>
                  <a className="hover:text-nirmaan font-bold py-1 rounded inline-flex items-center">
              ...
              {/* <span className="absolute right-0 top-0 text-xs px-3 py-1 bg-gradient-to-r from-blue-200 to-blue-400 rounded-bl-md font-bold flex justify-start align-middle items-center"><LightningBoltIcon className="w-4 h-4 mr-1"/> 50Pts</span> */}
            </div>
          );
        })
      ) : (
      ...
      <div className="border border-blue-400 flex justify-start items-center col-span-4 px-5 overflow-hidden bg-white rounded-xl text-gray-700">
        <div className="w-24 h-24 my-4">
        ...
        <div className="pl-5 my-4">
          ...
          <h4 className="text-md font-medium">{props.title}</h4>

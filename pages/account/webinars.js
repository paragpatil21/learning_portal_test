              ...
              <div className="grid space-x-1 lg:grid-cols-3 grid-cols-1">
                {webinars ? (
                  webinars.map((webinar) => {
                    if (webinar.course === StudentData().course || webinar.course ==="ALL"){
                    return (
                      <div className="">
                        <div className="card bg-white rounded-2xl">
                          {/* <img src={API_URL + webinar.Image} alt="cannot find" className="rounded-2xl rounded-b-none object-cover h-36 md:h-52 w-full" /> */}
                          <div className="m-5">
                            <div className="title">
                  ...
                  <div className="col-span-12 text-center py-5 mx-auto font-semibold">
                    <img src="../../../images/no-courses.svg" className="w-1/4 mx-auto mb-8" />
                    No webinars scheduled at this moment.
                  </div>
                )}
              </div>
            </div>

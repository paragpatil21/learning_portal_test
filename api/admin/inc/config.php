...
class Config
{
    ...
    const BASE_URL = 'http://localhost/learning-portal/nirmaan-learning-portal/api/';
    const CORS_DOMAINS = array('localhost:3000');

    const DB_NAME = "women_in_tech";
    const DB_PASS = "";
    const DB_HOST = "localhost";
    const DB_USER = "root";

    const SMTP_MAIL = "info@nirmaan.org";
    const SMTP_HOST = "nirmaan.org";
    const SMTP_USERNAME = "info@nirmaan.org";
    const SMTP_PASSWORD = "";
    const SMTP_PORT = "465";

              ...
              <div className="flex flex-col md:flex-row justify-between">
                ...
                <div>
                  <Link href="https://i1.wp.com/eforms.com/images/2017/07/Consent-Form-Template.png?fit=1600%2C2070&ssl=1">
                    <button className="mt-3 md:mt-0 bg-nirmaan px-4 md:px-5 py-3 text-md shadow-sm font-medium text-white rounded-lg hover:bg-nirmaan-dark"> <DownloadIcon className="h-6 w-6 inline-block"/> Download</button>
                  </Link>
                </div>
              </div>
                  ...
                  <div className="py-4 sm:py-5">
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      <div className="flex justify-center">
                        <div className="rounded-lg border bg-gray-50 lg:w-1/2">
                          <div className="m-4">
                          ...
                          <div className="flex p-2 space-x-4">
                            ...
                            <button className="ml-2 px-4 py-2 text-white bg-green-500 rounded">Upload</button>
                          </div>
                        </div>
                      </div>

...
export default function Topic() {
  ...
  const handleScroll = (e) => {
    //height difference check once and get it already done or  not
...
<div className="sticky" id="mydiv1">
          <div>
            <div className="bg-white border-b flex justify-between items-center p-3 py-5 lg:hidden">
              <Link href="/">
                <a>
              ...
              <Link href={"/courses/level/"+moduledata}>
                <a className="ml-28 text-gray-800 font-bold py-1 px-4 rounded inline-flex items-center">
            ...
            <div className="bg-white border-b flex justify-between items-center p-3 px-5 lg:hidden">
              <a href="#" className="text-md font-bold text-gray-900 rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                {courseData?.Title}
              </a>
              <div onClick={(e) => setTopicsMenu(true)} className={topicsMenu ? "hidden" : "block px-2 mr-2"}>
                <svg className="h-6 w-5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex ">
              ...
              <div className="flex-1 border overflow-y-scroll h-screen justify-center items-center md:p-10">
                <Link href={"/courses/level/"+moduledata}>
                  <a className="hidden lg:inline-flex ml-28 absolute top-5 right-10 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1 px-4 rounded items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16l-4-4m0 0l4-4m-4 4h18" />
                    </svg>
                    <span>Back</span>
                ...
                {/* <div onScroll={handleScroll}  style={{overflowY: 'scroll', maxHeight: '1400px'}} className="flex justify-center text-justify"> */}
                <div  className="flex justify-center text-justify  w-96 md:w-auto md:p-7" >
                  

                  {courseTopic && (
                    <div >
                      <article className="prose lg:prose-2xl">
                        <h2 className="pt-0 lg:pt-14 heading1 text-black">{courseTopic?.Title}</h2>
                        <div className="text1 mycontent w-96 p-2 md:p-0 md:w-auto" id="editorjs" dangerouslySetInnerHTML={{ __html: convertDataToHtml(courseTopic.Content) }}></div>
                      </article>
                      <Feedback topic={courseTopic?.ID} student={StudentData().UniqueID} />
                    </div>
                  )}
                </div>
              </div>

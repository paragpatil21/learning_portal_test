...
export default function Example() {
  ...
  function onFontLoading() {
    ...
    document.getElementById("heading1").style.fontSize =  localStorage.getItem("heading");;
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-12 mb-10">
            <div className="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
              <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl" id="heading1">Key Sponsors</h2>
              ...
              {supporters.map((person) => (
                <li key={person.name}>
                  <div className="space-y-6">
                    <img className="mx-auto h-20  xl:h-32" src={person.imageUrl} alt="" />

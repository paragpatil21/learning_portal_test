        ...
        <div
          ...
          <div className="hidden lg:flex flex-1 items-stretch justify-start">
            <div className="flex-shrink-0 flex items-center py-5 pl-5">
              ...
              {/* <Link href="h">
                <a className="ml-28 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-1 px-4 rounded inline-flex items-center">
          ...
          <ul className="divide-y divide-gray-100">
            <li className="hidden lg:block p-3 bg-nirmaan  text-center font-bold font-serif text-white">
              ...
              props.topics.map((topic, key) => (
                <div>
                  <Link href={"/courses/" + props.courseData.Slug + "/" + topic.Slug}>
                    <li className={classNames((topic.Slug === topicSlug ? `bg-gray-200 ` : ``) + ` p-3 hover:bg-gray-200 text-left cursor-pointer flex justify-between items-center text-black`)}>
          ...
          <div className="bg-blue-50 mt-3">
            ...
            <Link key={props.courseData.ID} href={"/quizzes/" + props.courseData.Slug}>
              <a className="mb-5 mx-5 bg-nirmaan hover:bg-blue-400 text-white font-bold py-2 px-4 rounded inline-flex items-center">

      ...
      <div>
        <section className="py-20 bg-indigo-100">
          <div className="container max-w-6xl mx-auto">
            {courses ? (
              <>
                <h2 className="text-4xl font-bold tracking-tight text-center">Exercises</h2>
                <p className="mt-2 text-lg text-center text-gray-600">Check out our list of exercises below.</p>
              </>
            ) : (
              ""
            )}

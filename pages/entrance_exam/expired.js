...
export default function Expired(){
    ...
    useEffect(() => {  
        if (isStudentLoggedIn() !== true || StudentData().status!='Not Attended Written Test') {
            Logout();
            router.push("../");
        }
        else
    ...
    return loading==false?(
        <>
            ...
            <div className="mt-36 mx-4 text-center">
                ...
                <h2 className="text-xl font-bold tracking-tight">You have not attended the exam on or before the given date. The exam link validity has expired. Contact us at shiksha@nirmaan.org or +91-9154172540, +91-6309987152 for further clarifications.</h2>
                <button

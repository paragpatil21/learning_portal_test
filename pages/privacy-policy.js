  ...
  return (
    <>
      ...
      <div className="mx-16 mb-8 pt-36 text-justify">
          <div className="ffont-heading text-3xl sm:text-4xl font-bold heading1 text-center mt-2 mb-10">
            Privacy Policy
          </div>
          ...
          <div className="py-1 px-14 text-gray-700">
            <ul className="list-disc space-y-2 text-justify">
              <li>
                Account registration information (username, education details {/*}, school, class,
                location */} and email).
              </li>
              <li>

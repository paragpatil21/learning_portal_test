...
import { CheckIcon, UserGroupIcon } from "@heroicons/react/outline";
...
export default function Quizzes() {
  ...
  function handleLockedPopup(message) {
    ...
    setLockedPopupData({ title: "Certification Locked", message: message, icon: "lock" });
  }
...
setLocalFonts("35px","15px");
  ...
  return pageLoading === false ? (
    <>
      ...
      <Header />
      <div>
        <section className="py-20 " id="mydiv1">
          <div className="container max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold tracking-tight text-center heading1">Certifications</h2>
            {courses ? (
              <>
                {/* <p className="mt-2 text-lg text-center text-gray-600">Check out our list of certifications below.</p> */}
              </>
            ) : (
              ""
            )}
            <div className="p-4 grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 md:grid-cols-12 sm:px-8 xl:px-0">
            ...
            <div className="relative flex flex-col items-center justify-between col-span-6 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 rounded-xl">
                ...
                <p className="text-base text-center text-gray-500">Complete assessment to get Web Development certificate.</p>
                <a
                    onClick={() => handleLockedPopup("Please Complete Web Development Course to Unlock the Certification")}
                    className="cursor-pointer flex justify-center items-center bg-opacity-60 bg-blue-500 text-white font-bold py-2 px-4 rounded-full duration-150 hover:scale-105 transform hover:shadow-2xl">
                ...
                {/*<Link href={isStudentLoggedIn() === true ? "/certifications/basic" : "/login?refer=/certifications/basic"} >
                  <a className="cursor-pointer flex justify-center items-center bg-blue-500 text-white font-bold py-2 px-4 rounded-full duration-150 hover:scale-105 transform hover:shadow-2xl">Start Assessment</a>
                </Link>*/}
              ...
              <div className="relative flex flex-col items-center justify-between col-span-6 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 rounded-xl">
                ...
                <p className="text-base text-center text-gray-500">Complete assessment to get Information Technology Enabled Services certificate.</p>
                <a
                    onClick={() => handleLockedPopup("Please Complete Information Technology Enabled Services Course to Unlock the Certification")}
                    className="cursor-pointer flex justify-center items-center bg-opacity-60 bg-blue-500 text-white font-bold py-2 px-4 rounded-full duration-150 hover:scale-105 transform hover:shadow-2xl">
                    <LockClosedIcon className="w-4 h-4 mr-2" /> Start Assessment
                  </a>
                {/*<Link href={isStudentLoggedIn() === true ? "/certifications/basic" : "/login?refer=/certifications/basic"} >
              ...
              <div className="relative flex flex-col items-center justify-between col-span-6 px-8 py-12 space-y-4 bg-gray-100 rounded-xl">
                ...
                <p className="text-base text-center text-gray-500">Complete assessment to get Soft Skills certificate.</p>
                <a
                    onClick={() => handleLockedPopup("Please Complete Soft Skills Course to Unlock the Certification")}
                    className="cursor-pointer flex justify-center items-center bg-opacity-60 bg-blue-500 text-white font-bold py-2 px-4 rounded-full duration-150 hover:scale-105 transform hover:shadow-2xl">
                    <LockClosedIcon className="w-4 h-4 mr-2" /> Start Assessment
                  </a>
                {/*certificateProgress >= 2 || certificateProgress == 1 ? (
                  <Link href={isStudentLoggedIn() === true ? "/certifications/intermediate" : "/login?refer=/certifications/intermediate"} >
                    <a className="cursor-pointer flex justify-center items-center bg-blue-500 text-white font-bold py-2 px-4 rounded-full duration-150 hover:scale-105 transform hover:shadow-2xl">Start Assessmet</a>
                  </Link>
                ) : (
                  <a
              ...
              {/* {courses ? (
                courses.map((course) => {
                  return (
                    <div className="duration-150 hover:scale-105 transform hover:shadow-2xl relative flex flex-col items-center justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden bg-gray-100 rounded-xl text-gray-700 hover:text-nirmaan">
                      <h4 className="text-xl font-medium">{course.Title}</h4>
                      <p className="text-base text-center text-gray-500">{course.Description}</p>
